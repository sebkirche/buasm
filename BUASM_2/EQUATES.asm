...
; WINDOWCLASS Structure Equates Windows
[WINDOWCLASS_style          (00*DWORD)
 WINDOWCLASS_lpfnWndProc    (01*DWORD)
 WINDOWCLASS_cbClsExtra     (02*DWORD)
 WINDOWCLASS_cbWndExtra     (03*DWORD)
 WINDOWCLASS_hInstance      (04*DWORD)
 WINDOWCLASS_hIcon          (05*DWORD)
 WINDOWCLASS_hCursor        (06*DWORD)
 WINDOWCLASS_hbrBackground  (07*DWORD)
 WINDOWCLASS_lpszMenuName   (08*DWORD)
 WINDOWCLASS_lpszClassName  (09*DWORD)]
_______________
