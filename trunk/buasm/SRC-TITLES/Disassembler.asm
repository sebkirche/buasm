...
Proc BuildCommentedCodeReference:
    ...
    Uses edx, esi, ebx, eax
      ...
      ; Get the actual position of the data label.
        ...
        Push esi | Mov esi  {W$ CRLF, B$ "; Referenced Routing Flags: Hex = " EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi
...
L1:     cmp al CHUNKEND | jnz L1>
            ...
            Push esi | Mov esi {B$ ' CHUNKEND +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi | jmp L2>>


L1:
        test eax INSTRUCTION ZERO L1>

            Push esi | Mov esi {B$ ' INSTRUCTION +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax EVOCATED ZERO L1>

            Push esi | Mov esi {B$ ' EVOCATED +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax NODE ZERO L1>

            Push esi | Mov esi {B$ ' NODE +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax LABEL ZERO L1>

            Push esi | Mov esi {B$ ' LABEL +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

;L1:    test eax CHUNKEND ZERO L1>

   ;         Push esi | Mov esi {B$ ' CHUNKEND +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax ACCESSED ZERO L1>

            Push esi | Mov esi {B$ ' ACCESSED +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax EXPORTNODE ZERO L1>

            Push esi | Mov esi {B$ ' EXPORTNODE +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax INDIRECT ZERO L1>

            Push esi | Mov esi {B$ ' INDIRECT +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax PUSH_EBP ZERO L1>

            Push esi | Mov esi {B$ ' PUSH_EBP +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi
...
Proc BuildCommentedDataReference:
    ...
    Uses edx, esi, ebx, eax
      ...
      ; Get the actual position of the data label:
        ...
        Push esi | Mov esi {W$ CRLF, B$ "; Referenced Size Flag for next data: Hex = " EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi
        ...
        test eax STRINGS ZERO L1>
            Push esi | Mov esi {B$ ' STRINGS +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax POINTER ZERO L1>
            Push esi | Mov esi {B$ ' POINTER +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax FP10 ZERO L1>
            Push esi | Mov esi {B$ ' FP10 +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax FP8 ZERO L1>
            Push esi | Mov esi {B$ ' FP8 +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax FP4 ZERO L1>
            Push esi | Mov esi {B$ ' FP4 +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax DWORD ZERO L1>
            Push esi | Mov esi {B$ ' DWORD +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax WORD ZERO L1>
            Push esi | Mov esi {B$ ' WORD +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi

L1:     test eax BYTE ZERO L1>
            Push esi | Mov esi {B$ ' BYTE +' EOS} | L0: test B$esi 0_FF ZERO P0> | movsb | jmp L0< | P0: Pop esi
L1:
    ...
    pushad
        ...
        .While esi < D$EndOfStringsMap
            If D$esi <> 0
                ...
                Mov edi STR.A.Trash | Call WriteEax | Mov D$edi ' -> ' | add edi 4
                Push esi
                    Mov esi D$esi
...
StartHllAnalyze:
    Mov eax D$SourceLen | add eax 1_000_000

    Call VirtualAlloc SymbolicCodeSource,
                      eax
...
CloseHllAnalyze:
    ...
    Call VirtualFree SymbolicCodeSource
...
SymbolicAnalyzes:
    ...
    While edi < D$STRUCT.EditData@SourceEnd
        Push edi
            Call ApiAnalyze
        Pop edi
...
L1: While edi < D$STRUCT.EditData@SourceEnd
        cmp D$edi eax | je L2>
            inc edi
    End_While
    ret
...
[OneDisLineUp | While B$edi <> LF | dec edi | End_While
                While B$edi < SPC | dec edi | End_While
...
;;
    ...
    Mov D$STRUCT.EditData@SourceEnd edi | sub edi D$CodeSource | Mov D$SourceLen edi
...
[DisDllName: D$ ?
 StartOfDisImport: D$ ?
 EndOfDisImport: D$ ?
 FirstDisImportName: D$ ?
 PointerToDisImportDirectory: D$ ?
 PointerToDisImportAddressTable: D$ ?
 DisImportRVA: D$ ?
 DisImportFilePointer: D$ ?
 LastPointerInOurApiTable: D$ ?
 DllMin: D$ ?
 DllMax: D$ ?]
...
[RegisterClassStructure: B$ 'Data0403060' EOS 0 0 0]
[LastRegisterClass: D$ ?
 ClassEx: D$ ?]
...
;;
    ...
    Call FirstDisSearch | On edi >= D$STRUCT.EditData@SourceEnd, jmp L9>>
    inc edi
    If D$ClassEx = 4
...
L0:     Mov al B$esi | sub al '0' | On al > 9, sub al 7 | add al B$ClassEx
    ...
    .While edi < D$STRUCT.EditData@SourceEnd
        While B$edi <> SPC | inc edi | End_While | inc edi
...
L1: Mov esi D$CodeToMainWindowProc, edi RegisterClassStructure
  ...
  ; Make room for CRLF 'MainWindowProc: ':
    Push edi
        ...
        std | rep movsb | cld
        add D$STRUCT.EditData@SourceEnd 18 | add D$SourceLen 18
    Pop edi
...
L0:     test B$ebx+eax LABEL ZERO L1>
...
L0:         Mov al B$ebx | inc ebx
        ...
        sub ebx eax | cmp ebx 5 | jb L9>
          ...
          ; Valid String found: Flag the String:
            sub eax D$UserPeStart | add eax D$RoutingMap | or B$eax STRINGS+ASCII
          ; FLAG the Pointer:
...
L0: Mov ebx D$eax+SECTION_FLAG
    test ebx &IMAGE_SCN_MEM_EXECUTE NOT_ZERO L1>
