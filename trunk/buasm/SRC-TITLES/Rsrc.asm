...
[RsrcData1:  D$01111_1111 B$'TypeB' EOS 'NameB' EOS
 RsrcData2:  D$02222_2222 B$'TypeB' EOS 'NameB' EOS
 RsrcData3:  D$03333_3333 B$'TypeB' EOS 'NameA' EOS
 RsrcData4:  D$04444_4444 B$'TypeA' EOS
 RsrcData5:  D$05555_5555 B$'NameC' EOS
 RsrcData6:  D$06666_6666 B$'Abcd' EOS
