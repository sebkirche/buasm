...
[EqualPreparser_ParameterInvalid: B$ 'Invalid integrated function parameter.' EOS]
[EqualPreparser_InvalidFPValue: B$ 'Invalid floating point value.' EOS]
[EqualPreparser_OptimisationError: B$ 'Error occurred while optimizing. Please report this error :)' EOS]
...
[EqualPreparser_InvalidStringinSource: B$ 'Invalid string in source operand.' EOS]
...
[TempSourceBuffer: D$ ? # 1024]

[ShowSourceTitle: B$ 'SOURCE '] ; !!!
[ShowSourceTitle_ID: D$ 0 0 0 ]                    ; [<ShowSourceTitle_ID: 0 0 0 ]  disables the breakpoints !!!!!
