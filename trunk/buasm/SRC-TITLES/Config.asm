...
[NotYet: B$ ' Will be available for next release...' EOS]
...
[Asm32HelpPath: B$ 'Asm32HelpPath' EOS]
[WinApiPath: B$ 'WinApiPath' EOS]
[AsmHelPath: B$ 'AsmHelPath' EOS]
...
[StrucPath: B$ 'StrucPath' EOS]

[LastUserPath: B$ 'LastUserPath' EOS]
...
[UserConfigString: B$ 'UserConfig' EOS]
