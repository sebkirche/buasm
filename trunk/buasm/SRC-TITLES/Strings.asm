...
L5:         Call 'USER32.MessageBoxA' 0, {B$ 'Bad National Strings File. English assumed' EOS},
...
[STR.A.Test: B$ 'Access violation at address #1. Tried to read from #2 address' EOS]

TestCustomString:

    CustomString STR.A.Test '#1',
                            'Int',
                            0112233,
                            '#2',
                            'Str',
