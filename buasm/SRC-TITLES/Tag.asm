...
NewWizardForm:
    ...
    Call 'USER32.MessageBoxA' &NULL {B$ 'Set the caret where you want the code to be pasted, and click OK.' EOS},
...
Proc LoadWizardAndPasteCode:
    ...
    If eax = 0
        Call 'USER32.MessageBoxA' &NULL {B$ "The Wizard cannot be loaded." EOS},
