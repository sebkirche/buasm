...
[DevILHlpMessage: B$ "Copy 'DevIL.html' in this directory
or run [Config] menu option" EOS]
...
[CbBuffer:
 ...
 lfFaceName: B$ 'Courier New' EOS] [CBBsecurityTail: 0 # 5] ; 32 Bytes > Total lenght = 60 Bytes
...
Proc InitGUIDsView:
    ...
    ...Else
        Call 'USER32.MessageBoxA' 0, MissingGUIDsFile, {B$ 'File not found' EOS}, 0
