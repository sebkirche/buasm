...
X1:     Mov edi D$BaseNamePointer
    ...
    ..If eax = &FALSE
        ...
        .If eax = &ERROR_FILE_EXISTS
            ...
            Call 'USER32.MessageBoxA' &NULL, {B$ 'Overwrite?' EOS},
...
[PreParseEqual: B$ "PREPARSE Equal
      ...
      ; exe/Start/Menu:
        .If al = 10
          ; Menu:
            ...
            Push edi
                Mov edi D$LP.MemTrash | rep movsb
            Pop edi
...
L1: Mov D$edi CRLF2 | add edi 4 | Mov D$STRUCT.EditData@SourceEnd edi
...
L9: Call GetEditWindowClientRectangle
    ...
    Mov B$OnReplaceAll &FALSE, D$FL.BlockInside &FALSE, B$DownSearch &TRUE, D$FL.ReadyToRun &FALSE
...
[BasesNames:
 Base_01.exe: B$ 'Base_01.exe' EOS
 Base_02.exe: B$ 'Base_02.exe' EOS
 Base_10.exe: B$ 'Base_10.exe' EOS
 Base_11.exe: B$ 'Base_11.exe' EOS

 Base_03.dll: B$ 'Base_03.dll' EOS
 Base_04.dll: B$ 'Base_04.dll' EOS
 Base_05.dll: B$ 'Base_05.dll' EOS, 0]
...
[ListNumerix: D$ ?]  ; this value is to be add to tables pointers to jmp over numeric data
...
L1:             While B$esi > LowSigns | movsb | End_While
            ...
            .Else
              ; Skip non-Equates:
                test B$esi 00_1000_0000 NOT_ZERO L1<
...
[BadEquateLineMessage: B$ "Bad Equate line in Equates.equ: 
...
L0: Mov edi BadEquateLineLine
    ...
    Call MessageBox BadEquateLineMessage

ret

____________________________________________________________________________________________

[DuplicatedEquate: B$ 'Duplicated Equates' EOS]
...
L0: Call MessageBox STR.A.Trash
