...
[WaveType: U$ 'WAVE'    AviType: U$ 'AVI'] [WAVETYPELEN 4    AVITYPELEN 3] ; 'SOUND'
...
[CursorList: D$ ? # MAXCURSOR]      [CursorListPtr: D$ CursorList]
[GroupCursorList: D$ ? # MAXCURSOR] [GroupCursorListPtr: D$ GroupCursorList]
[IconList: D$ ? # MAXICON]          [IconListPtr: D$ IconList]
[MenuList: D$ ? # MAXMENU]          [MenuListPtr: D$ MenuList]
[DialogList: D$ ? # MAXDIALOG]      [DialogListPtr: D$ DialogList]
[StringsList: D$ ? # MAXSTRINGS]    [StringsListPtr: D$ StringsList]
[GroupIconList: D$ ? # MAXICON]     [GroupIconListPtr: D$ GroupIconList]
[WaveList: D$ ? # MAXWAVE]          [WaveListPtr: D$ WaveList]
[AviList: D$ ? # MAXAVI]            [AviListPtr: D$ AviList]
[RCdataList: D$ ? # MAXRCDATA]      [RCdataListPtr: D$ RCdataList]
[BitMapList: D$ ? # MAXBITMAP]      [BitMapListPtr: D$ BitMapList]

[OtherList: D$ ?
 OtherListPtr: D$ ?]

[FontFilesTitle: B$ 'Choose a Font File' EOS
 ...
 MenuFilesTitle: B$ 'Choose a Menu Template File' EOS]
